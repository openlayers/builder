...
/**
 * Release constructor.
 * @param {Object} options Object with name and url properties.
 * @constructor
 */
 ...
 * @param {Object} options Build configuration object.  Must have an "exports"
 ...
 *     or any error.
 */
Release.prototype.build = function(options, callback) {
  var name = this.name;
